...
2. It looks real. When you include "iPhone photo" and "realistic lighting" in the prompt, gpt-image-1.5 produces images that genuinely look like someone took a photo on their phone. Not AI art. Not renders. Photos.
   ...
   > So the workflow is:
3. Larry generates images, adds text overlays, writes the caption
4. Larry uploads everything to TikTok as a draft via Postiz
5. Larry sends me the caption in a message (I can't get the draft post to write the caption too)
6. I open TikTok, pick a trending sound, paste the caption and hit publish.
